...
def main(args):
    ...
    set_test = torchvision.datasets.ImageFolder(
        args.test_dir, transform=transform_test
    )
    ...
    train_loader = create_data_loaders(
        ...
        data=torch.utils.data.ConcatDataset([set_train, set_valid]),
        batch_size=args.batch_size,
    )
    test_loader = create_data_loaders(
        data=set_test, batch_size=args.test_batch_size
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--test-dir", default=os.environ["SM_CHANNEL_TESTING"], type=str
    )
    parser.add_argument(
